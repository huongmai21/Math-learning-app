...
const Profile = () => {
  ...
  // Hiển thị giao diện lỗi thân thiện hơn
  if (error) {
    return (
  ...
  // Đảm bảo luôn có dữ liệu profile
  if (!profile) {
    return (
      <div className="error-container">
        <div className="error-content">
          ...
          <p>Hồ sơ người dùng không tồn tại hoặc bạn không có quyền truy cập.</p>
    ...
    >
      <div className="profile-header">
        <div className="profile-cover">
          <img
            src={profile.coverImage || "https://res.cloudinary.com/duyqt3bpy/image/upload/v1746934942/4_fpzzq2.png"}
            alt="Cover"
            className="cover-image"
            onError={(e) => {
              e.target.src = "https://res.cloudinary.com/duyqt3bpy/image/upload/v1746934942/4_fpzzq2.png"
            }}
          />
      ...
      <div className="profile-content">
        ...
        <div className="profile-tab-content">
          {activeTab === "overview" && (
            <OverviewTab profile={profile} isCurrentUser={isCurrentUser} contributions={contributions} />
          )}
